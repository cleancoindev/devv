...
build:
	...
	docker build --build-arg "BUILD_VERSION=16" -t isjavi-devv-node -t isjavi-devv-node:16 -t isjavi-devv-node:latest ./docker/node
	...
	docker build --build-arg "BUILD_VERSION=8-fpm" -t isjavi-devv-php -t isjavi-devv-php:8 -t isjavi-devv-php:latest ./docker/php
